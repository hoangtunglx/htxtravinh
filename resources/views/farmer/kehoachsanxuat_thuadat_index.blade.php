      ...
      <div class="card-body">
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tr>
            ...
            <td class="text-center">              
                @csrf()                
                <a href="{{ route('farmer.kehoachsanxuat_thuadat.edit', ['id' => $keHoachSanXuat_ThuaDat->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
              </form>
            </td>
          </tr>
          @endforeach
