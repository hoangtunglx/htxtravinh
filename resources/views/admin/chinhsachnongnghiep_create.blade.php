    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          ...
          <a href=" {{ route('admin.chinhsachnongnghiep.index') }} "><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Chính sách nông nghiệp</a>
        </li>
      </ol>
    </nav>
    <div class="d-md-flex align-items-md-start">
      <h1 class="page-title mr-sm-auto"> Chính sách nông nghiệp<small> Tạo mới </small> </h1>
    </div>
  </header>
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('admin.chinhsachnongnghiep.store') }} " method="post" enctype="multipart/form-data">
          @csrf()
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('tenchinhsach') is-invalid @enderror" id="tenchinhsach" name="tenchinhsach" value="{{old('tenchinhsach')}}" placeholder="Tên chính sách" >
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('sovanban') is-invalid @enderror" id="sovanban" name="sovanban" value="{{old('sovanban')}}" placeholder="Số văn bản" >
            ...
            <div class="form-group">
              ...
              <textarea class="form-control ckeditor @error('tomtatvanban') is-invalid @enderror" id="tomtatvanban" name="tomtatvanban" >{{old('tomtatvanban')}}</textarea>
