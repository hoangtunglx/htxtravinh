    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          ...
          <a href=" {{ route('admin.loainongsan.index') }} "><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Loại nông sản</a>
        </li>
      </ol>
    </nav>
  ...
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('admin.loainongsan.store') }} " method="post">
          @csrf()
          <fieldset>
            <div class="form-group">
              <label for="tenloainongsan">Tên loại nông sản <abbr title="Required">*</abbr></label>
              <input type="text" class="form-control @error('tenloainongsan') is-invalid @enderror" id="tenloainongsan" name="tenloainongsan" value="{{old('tenloainongsan')}}" placeholder="Tên loại nông sản" autofocus>
