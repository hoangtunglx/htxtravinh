    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          ...
          <a href=" {{ route('admin.goiyphanbonnuoctuoi.index') }} "><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Gợi ý phân bón nước tưới</a>
        </li>
      </ol>
    </nav>
  ...
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('admin.goiyphanbonnuoctuoi.store') }} " method="post">
          @csrf()
          <fieldset>
