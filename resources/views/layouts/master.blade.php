...
<head>
	...
	<link rel="stylesheet" href="{{asset('public/admin/vendor/open-iconic/css/open-iconic-bootstrap.min.css')}} " />
	<link rel="stylesheet" href="{{asset('public/admin/vendor/fontawesome/css/all.css')}} " />
	<link rel="stylesheet" href="{{asset('public/admin/vendor/flatpickr/flatpickr.min.css')}} ">
	...
	<link rel="stylesheet" href="{{asset('public/admin/stylesheets/jquery.dataTables.min.css')}} " />
...
<body>
				...
				<div class="top-bar-list">
										...
										<div class="list-group list-group-flush list-group-reflow mb-2">
											...
											<div class="list-group-item py-2">
												...
												<div class="user-avatar user-avatar-sm bg-muted">
													<img src=" {{asset('public/admin/images/avatars/bootstrap.svg')}} " alt="">
												</div>
												<div class="ml-2">
											...
											<div class="list-group-item py-2">
												<a href="#" class="stretched-link"><span class="sr-only">Go to search result</span></a>
												<div class="user-avatar user-avatar-sm bg-muted">
													<img src=" {{asset('public/admin/images/avatars/slack.svg')}} " alt="">
												</div>
												<div class="ml-2">
					...
					<div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
									...
									<div class="dropdown-scroll perfect-scrollbar">
										...
										<a href="#" class="dropdown-item unread">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces15.jpg')}} " alt="">
											</div>
										...
										<a href="#" class="dropdown-item unread">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces16.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces17.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces18.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces19.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces20.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/uifaces21.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
							...
							<li class="nav-item dropdown header-nav-dropdown has-notified">
								...
								<div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
									...
									<div class="dropdown-scroll perfect-scrollbar">
										...
										<a href="#" class="dropdown-item unread">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/team1.jpg')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/team3.png')}} " alt="">
											</div>
											<div class="dropdown-item-body">
										...
										<a href="#" class="dropdown-item">
											<div class="user-avatar">
												<img src=" {{asset('public/admin/images/avatars/team2.png')}} " alt="">
											</div>
											<div class="dropdown-item-body">
						...
						<div class="dropdown d-flex">
							<button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src=" {{asset('public/admin/images/avatars/profile.jpg')}} " alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> 
		...
		<aside class="app-aside app-aside-expand-md app-aside-light">
			...
			<div class="aside-content">
				...
				<header class="aside-header d-block d-md-none">
					...
					<button class="btn-account" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span class="user-avatar user-avatar-lg"><img src=" {{asset('public/admin/images/avatars/profile.jpg')}} " alt=""></span> <span class="account-icon"><span class="fa fa-caret-down fa-lg"></span></span> <span class="account-summary"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> 
	...
	<script src=" {{asset('public/admin/vendor/bootstrap/js/popper.min.js')}} "></script>
	...
	<script src=" {{asset('public/admin/vendor/stacked-menu/stacked-menu.min.js')}} "></script>
	<script src=" {{asset('public/admin/vendor/perfect-scrollbar/perfect-scrollbar.min.js')}} "></script>
	<script src=" {{asset('public/admin/vendor/flatpickr/flatpickr.min.js')}} "></script>
	<script src=" {{asset('public/admin/vendor/easy-pie-chart/jquery.easypiechart.min.js')}} "></script>
	...
	<script src=" {{asset('public/admin/javascript/pages/dashboard-demo.js')}} "></script>

	<script src=" {{asset('public/admin/javascript/pages/dataTables.bootstrap.js')}} "></script>
	...
	<script>
		...
		loc = window.location.href.trim();

		$('ul.menu li a').each(function(i)
		{
			if (loc === $(this).attr("href").trim() )
			{
