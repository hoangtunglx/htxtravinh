...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.loainongsan.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <form action="{{route('officer.loainongsan.delete', ['id'=>$loaiNongSan->id])}}" method="post">
                  @csrf()
                  @method('DELETE')
                  <a href="{{ route('officer.loainongsan.edit', ['id' => $loaiNongSan->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
