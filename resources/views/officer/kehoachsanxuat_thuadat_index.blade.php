...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.kehoachsanxuat_thuadat.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
  ...
  <div class="page-section">
    ...
    <div class="card card-fluid">
      ...
      <div class="card-body">
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tr>
            ...
            <td class="text-center">
              <form action="{{route('officer.kehoachsanxuat_thuadat.delete', ['id'=>$keHoachSanXuat_ThuaDat->id])}}" method="post">
                @csrf()
                @method('DELETE')
                <a href="{{ route('officer.kehoachsanxuat_thuadat.edit', ['id' => $keHoachSanXuat_ThuaDat->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
	  ...
	  <div class="card-footer">
          <a href="{{ route('officer.kehoachsanxuat_thuadat.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
