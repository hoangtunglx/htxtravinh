    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          ...
          <a href=" {{ route('officer.goiyphanbonnuoctuoi.index') }} "><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Tiêu chuẩn sản xuất</a>
        </li>
      </ol>
    </nav>
  ...
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('officer.goiyphanbonnuoctuoi.update') }} " method="post" >
          @csrf()
          @method('PUT')
