		...
		<ul class="menu">
			...
			<li class="menu-item has-child">
				...
				<ul class="menu">
					...
					<li class="menu-item">
						<a href="{{ route('officer.doanhnghiep.index') }}" class="menu-link"><span class="menu-icon far fa-leaf"></span> <span class="menu-text">Doanh nghiệp</span> </a>
					</li>
					
					<li class="menu-item">
						<a href="{{ route('officer.vungnguyenlieu.index') }}" class="menu-link"><span class="menu-icon fa fa-leaf"></span> <span class="menu-text">Vùng nguyên liệu</span> </a>
					</li>
					<li class="menu-item">
						<a href="{{ route('officer.thuadat.index') }}" class="menu-link"><span class="menu-icon far fa-leaf"></span> <span class="menu-text">Thửa đất</span> </a>
					</li>
					...
					<li class="menu-item">
						<a href="{{ route('officer.kehoachsanxuat_thuadat.index') }}" class="menu-link"><span class="menu-icon far fa-certificate"></span> <span class="menu-text">Kế hoạch sản xuất thửa đất</span> </a>
					</li>
