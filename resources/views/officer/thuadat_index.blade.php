...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('admin.thuadat.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tr>
            ...
            <td class="text-center">
              <form action="{{route('admin.thuadat.delete', ['id'=>$thuaDat->id])}}" method="post">
                @csrf()
                @method('DELETE')
                <a href="{{ route('admin.thuadat.edit', ['id' => $thuaDat->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
          ...
          <a href="{{ route('officer.thuadat.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
