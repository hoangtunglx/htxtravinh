...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.thongtinthoitiet.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
            ...
            <tr>
              ...
              <td class="text-center">
                <form action="{{route('officer.thongtinthoitiet.delete', ['id'=>$thongTinThoiTiet->id])}}" method="post">
                  @csrf()
                  @method('DELETE')
                  <a href="{{ route('officer.thongtinthoitiet.edit', ['id' => $thongTinThoiTiet->id]) }}" class="btn btn-warning btn-sm btn-icon" title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
<button type="submit" class="btn btn-danger btn-delete btn-sm btn-icon" title="Xóa"> <i class="fa fa-trash"></i></button>
      ...
      <div class="card-footer">
          <a href="{{ route('officer.thongtinthoitiet.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
