...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.doanhnghiep.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
  ...
  <div class="page-section">
    ...
    <div class="card card-fluid">
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <form action="{{route('officer.doanhnghiep.delete', ['id'=>$doanhNghiep->id])}}" method="post">
                @csrf()
                @method('DELETE')
                <a href="{{ route('officer.doanhnghiep.edit', ['id' => $doanhNghiep->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
      ...
      <div class="card-footer">
          <a href="{{ route('officer.doanhnghiep.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
