...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.thongtinmoitruong.create',['id' => $dsThuaDat->id]) }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
  ...
  <div class="page-section">
    <div class="card card-fluid">
      ...
      <div class="card-footer">
          <a href="{{ route('officer.thongtinmoitruong.create',['id' => $dsThuaDat->id]) }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
