...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.thongtinthitruong.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
  ...
  <div class="page-section">
    ...
    <div class="card card-fluid">
          ...
          <tbody>
            ...
            <td> {{ $thongTinThiTruong->chinhsachkhuyenmai }} </td>
              <td class="text-center">
                <form action="{{route('officer.thongtinthitruong.delete', ['id'=>$thongTinThiTruong->id])}}" method="post">
                  @csrf()
                  @method('DELETE')
                  <a href="{{ route('officer.thongtinthitruong.edit', ['id' => $thongTinThiTruong->id]) }}" class="btn btn-warning btn-sm btn-icon" title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
      ...
      <div class="card-footer">
          <a href="{{ route('officer.thongtinthitruong.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
