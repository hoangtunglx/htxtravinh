...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('officer.phuongtiensx.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
  ...
  <div class="page-section">
    <div class="card card-fluid">
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> {{ $phuongTienSX->HopTacXa->tenhtx }} </td>
              <td> {{ $phuongTienSX->LoaiPhuongTien->tenloaiphuongtien }} </td>
              <td> {{ $phuongTienSX->tenphuongtien }} </td>
              <td> {{ \Carbon\Carbon::parse($phuongTienSX->ngaymua)->format('d/m/Y')}}
 </td>
              ...
              <td class="text-center">
                <form action="{{route('officer.phuongtiensx.delete', ['id'=>$phuongTienSX->id])}}" method="post">
                  @csrf()
                  @method('DELETE')
                  <a href="{{ route('officer.phuongtiensx.edit', ['id' => $phuongTienSX->id]) }}" class="btn btn-warning btn-sm btn-icon" title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
      ...
      <div class="card-footer">
          <a href="{{ route('officer.phuongtiensx.create') }}" class="card-footer-item btn-outline-success" title="Thêm mới"> <i class="fa fa-plus-circle"></i> Thêm mới </a>
      </div>
    </div>
  </div>
</div>
