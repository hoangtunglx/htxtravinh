...
class PhuongTienSXRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'loaiphuongtien_id.required' => 'Vui lòng chọn loại phương tiện',
            'masophuongtien.required' => 'Vui lòng nhập mã số phương tiện',
            'masophuongtien.unique' => 'Mã số phương tiện đã tồn tại',
            ...
            'nuocsanxuat.max' => 'Nước sản xuất vượt quá ký tự cho phép',
            'dientich.max' => 'Diện tích vượt quá ký tự cho phép',
            'vitri.max' => 'Vị trí vượt quá ký tự cho phép',
            'mota.max' => 'Môt tả vượt quá ký tự cho phép',
            'trangthai.max' => 'Trạng thái vượt quá ký tự cho phép',
