...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" <?php echo e(route('admin.nongsan.create')); ?> "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tr>
            ...
            <td class="text-center">
              <form action="<?php echo e(route('admin.nongsan.delete', ['id'=>$nongSan->id])); ?>" method="post">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
                <a href="<?php echo e(route('admin.nongsan.edit', ['id' => $nongSan->id])); ?>" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\htxtravinh\resources\views/admin/nongsan_index.blade.php ENDPATH**/ ?>