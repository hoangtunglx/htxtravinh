...
<head>
	...
	<title>Đăng nhập - <?php echo e(config('app.name', 'LPortal')); ?></title>
	...
	<link rel="stylesheet" href="<?php echo e(asset('public/admin/vendor/@fortawesome/fontawesome-free/css/all.min.css')); ?>" />
...
<body>
	<main class="auth">
		<header id="auth-header" class="auth-header" style="background-image: url(<?php echo e(asset('public/admin/images/illustration/img-1.png')); ?>);">
			<h1>
		...
		<form class="auth-form" action="<?php echo e(route('login')); ?>" method="post">
			...
			<div class="form-group">
				<div class="form-label-group">
					<input type="text" id="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control <?php $__errorArgs = ['email', 'username'];
...
unset($__errorArgs, $__bag); ?>
			...
			<div class="form-group">
				<a href="<?php echo e(url('/login/google')); ?>" class="btn btn-lg btn-danger btn-block"><i class="fab fa-google"></i> Đăng nhập bằng Gmail</a>
			</div>
			...
			<?php if(Route::has('password.request')): ?>
				<div class="text-center pt-2">
					<a href="<?php echo e(route('password.request')); ?>" class="link">Quên mật khẩu đăng nhập?</a>
				</div>
			<?php endif; ?>
		</form>
		<footer class="auth-footer">
			Bản quyền &copy; <?php echo e(date('Y')); ?> bởi <?php echo e(config('app.name', 'LPortal')); ?>.
		</footer>
	</main>
	<script src="<?php echo e(asset('public/admin/vendor/jquery/jquery.min.js')); ?>"></script>
	<script src="<?php echo e(asset('public/admin/vendor/popper.js/umd/popper.min.js')); ?>"></script>
	<script src="<?php echo e(asset('public/admin/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
	<script src="<?php echo e(asset('public/admin/vendor/particles.js/particles.min.js')); ?>"></script>
	<script>
		$(document).on('theme:init', () => {
			particlesJS.load('auth-header', '<?php echo e(asset('public/admin/javascript/pages/particles.json')); ?>');
		});
	</script>
	<script src="<?php echo e(asset('public/admin/javascript/theme.min.js')); ?>"></script>
</body>
</html><?php /**PATH D:\Wamp64\www\htxtravinh\resources\views/auth/login.blade.php ENDPATH**/ ?>